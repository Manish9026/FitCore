...
const BannerSlider = () => {
  ...
  return (
    <div className="relative h-screen sm:min-h-[600px] min-h-[120vh] overflow-hidden ">
      <AnimatePresence mode="wait">
        <motion.div
          key={currentSlide}
          initial={{ opacity: 0, scale: 1.1 }}
        ...
        >
          ...
          {/* Content */}
          <div className="relative z-10 min-h-full flex items-center pt-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                ...
                <motion.div
                  ...
                  animate={{ opacity: 1, x: 0 }}
                  transition={{ duration: 0.8, delay: 0.2 }}
                  className="text-white space-y-4 lg:space-y-6 text-center lg:text-left"
                >
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.6, delay: 0.3 }}
                    className="inline-block px-4 py-2 bg-white/20 backdrop-blur-sm rounded-full text-sm font-medium mx-auto lg:mx-0"
                  >
                    {slides[currentSlide].subtitle}
                  </motion.div>
                  ...
                  <motion.p
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.6, delay: 0.5 }}
                    className="text-lg sm:text-xl lg:text-2xl text-white/90 max-w-2xl leading-relaxed mx-auto lg:mx-0"
                  >
                    {slides[currentSlide].description}
                  </motion.p>
                  ...
                  >
                    <motion.button
                      whileHover={{ scale: 1.05, boxShadow: "0 20px 40px rgba(255,255,255,0.2)" }}
                      whileTap={{ scale: 0.95 }}
                      className="group px-6 sm:px-8 py-3 sm:py-4 bg-white text-gray-900 font-bold rounded-xl shadow-lg flex items-center justify-center space-x-2 hover:bg-gray-100 transition-all text-sm sm:text-base"
                    >
                      <span>Shop Now</span>
                      <motion.div
                        animate={{ x: [0, 5, 0] }}
                    ...
                    <motion.button
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      className="group px-6 sm:px-8 py-3 sm:py-4 bg-white/20 backdrop-blur-sm text-white font-bold rounded-xl border border-white/30 hover:bg-white/30 transition-all flex items-center justify-center space-x-2 text-sm sm:text-base"
                    >
                      <Play className="h-5 w-5" />
                      <span>Watch Demo</span>
                    </motion.button>
                ...
                <motion.div
                  ...
                  animate={{ opacity: 1, x: 0 }}
                  transition={{ duration: 0.8, delay: 0.4 }}
                  className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-1 gap-3 sm:gap-4 mt-8 lg:mt-0"
                >
                  {slides[currentSlide].stats.map((stat, index) => (
                    <motion.div
                      key={index}
                      ...
                      transition={{ duration: 0.6, delay: 0.5 + index * 0.1 }}
                      whileHover={{ scale: 1.05, y: -5 }}
                      className="bg-white/10 backdrop-blur-lg rounded-2xl p-4 sm:p-6 border border-white/20 hover:bg-white/20 transition-all group"
                    >
